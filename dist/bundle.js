...
function handleModal(){
    ...
    closeButton.addEventListener("click", _todoModal__WEBPACK_IMPORTED_MODULE_8__.toggleModal);
...
/* harmony import */ var _manageLocalStorage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./manageLocalStorage */ "./src/manageLocalStorage.js");
    ...
    function removeTodo(project, title){
        const projects = _manageLocalStorage__WEBPACK_IMPORTED_MODULE_2__.manageLocal.getProjects()
        const complete = _manageLocalStorage__WEBPACK_IMPORTED_MODULE_2__.manageLocal.getCompleted()
            ...
            if(projects[i]._id === filtered._id){
                for(let j = 0; j <= projects[i].todos.length-1; j++){
                    if(projects[i].todos[j]._title == title){
                        ...
                        ;(0,_events__WEBPACK_IMPORTED_MODULE_1__.removeToDoBtn)()
                    }
                }
            }
        }
...
const renderToDo = ((todos)=>{
    ...
    for(let i = 0; i < todos.length; i++){
          ...
          //Due date
            ...
            dueDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(todos[i].dueDate), 'MM/dd/yyyy')
...
function populateModal(id) {
    ...
    dueDate.innerHTML = 'Due On ' + (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(todo[0].dueDate),'MM/dd/yyyy')
    //Priority
