...
const renderCompleteView =  (()=>{
    ...
    wrapper.innerHTML = ''
    ;(0,_renderDom__WEBPACK_IMPORTED_MODULE_3__.renderToDo)(getCompletedTodos)
})
...
function submitToDo(e){
    ...
    removeToDoBtn()
    ;(0,___WEBPACK_IMPORTED_MODULE_6__.start)()
}
...
const init = (()=>{
    ...
    ;(0,_events__WEBPACK_IMPORTED_MODULE_6__.removeToDoBtn)()
...
function handleActiveClassIcon(target){
    ...
    ;(0,_events__WEBPACK_IMPORTED_MODULE_6__.removeToDoBtn)()//Initializes the function or it wont work
    ;(0,_events__WEBPACK_IMPORTED_MODULE_6__.handleModal)()
    const btn = document.querySelector('.add-todo')
            ...
            if(projects[i]._id === filtered._id){
                for(let j = 0; j <= projects[i].todos.length-1; j++){
                    if(projects[i].todos[j]._title == title){
                        ...
                        ;(0,_events__WEBPACK_IMPORTED_MODULE_2__.removeToDoBtn)()
                    }
                }
            }
        }
        ...
        if(filtered){
            for(let i = 0; i < complete.length; i++){
                if(complete[i]._id === filtered._id){
                    complete.splice(i, 1)
                    localStorage.setItem('complete', JSON.stringify(complete))
                    ;(0,_events__WEBPACK_IMPORTED_MODULE_2__.removeToDoBtn)(id)
                }
            }
        }
    }
...
const updateView =(state) =>{
    if(state == 'todo'){
        ...
        ;(0,_events__WEBPACK_IMPORTED_MODULE_3__.removeToDoBtn)()
